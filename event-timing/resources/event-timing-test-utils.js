...
async function testDuration(t, id, numEntries, dur, fastDur, slowDur) {
  ...
  // * Asserting that if the durThreshold is greater than or equal to the processingDelay,
  //   |numEntries| entries are received.
  // * Asserting that if the durThreshold is smaller than the processingDelay,
  //   the number of entries we receive should be less than |numEntries|.
  // Parameters:
  // |t|                     - the test harness.
  // |id|                    - the ID of the element to be clicked.
